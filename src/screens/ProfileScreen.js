  ...
  return (
    <SafeAreaView>
      ...
      <View className="self-center mt-2 justify-center items-center">
        <Text className="text-base font-bold">Vo Vy Khang</Text>
        <TouchableOpacity onPress={() => navigation.navigate('EditProfileScreen')}>
          <Text className="text-[#00C187] font-bold mt-1">Edit profile</Text>
        </TouchableOpacity>
      </View>

      <TouchableOpacity onPress={() => navigation.navigate('NotificationProfileScreen')} className="flex-row justify-between mx-6 items-center mt-14">
      ...
      <TouchableOpacity onPress={() => navigation.navigate('ChangeLanguageScreen')} className="flex-row justify-between mx-6 items-center mt-10">
        <View className="flex-row items-center space-x-2">
      ...
      <TouchableOpacity onPress={() => navigation.navigate('GetHelpScreen')} className="flex-row justify-between mx-6 items-center mt-10">
        <View className="flex-row items-center space-x-2">
      ...
      <TouchableOpacity className="flex-row justify-between mx-6 items-center mt-10">
        <View className="flex-row items-center space-x-2">
