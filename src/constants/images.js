...
export {default as car} from '../assets/images/car.png'
export {default as camera} from '../assets/images/Cctv.png'
export {default as shirt} from '../assets/images/Shirt.png'
export {default as house} from '../assets/images/home-wifi.png'
export {default as shop} from '../assets/images/shop-check.png'
export {default as background_header} from '../assets/images/backgroundHeader.png'
export {default as map} from '../assets/images/map.png'
export {default as vector} from '../assets/images/Vector.png'
export {default as background_success} from '../assets/images/background_booking_success.png'
export {default as success_icon} from '../assets/images/success_icon.png'
export {default as ticket} from '../assets/images/ticket.png'
export {default as ticket_fill} from '../assets/images/Ticket_fill.png'
